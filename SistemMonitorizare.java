   ...
   public SistemMonitorizare(int nrCamere, String tipCamere, LocalDate dataAchizitie, TipAlarma alarma){
    ...
    public void salvare(String numeFisier, File logFile) {
    	...
    	try {
    		...
    		filePrint.println("Sistem monitorizare: ");
    		filePrint.println("      Nr camere: " + this.nrCamere);
    		filePrint.println("      Tip camere: " + this.tipCamere);
    		filePrint.println("      Data achizitionare: " + this.dataAchizitie);
    		filePrint.println("      Status sistem: " + this.alarma);
